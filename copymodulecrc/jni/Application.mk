...
APP_ABI := armeabi armeabi-v7a mips x86 x86_64     # This setting tells the NDK to build two versions of your machine code (e.g. all)
#APP_OPTIM := release                              # Define this optional variable as either release or debug
#APP_PIE = true                                    # From Android 5.0 (API level 21), executables require PIE. To use PIE to build your executables, set the -fPIE flag.
